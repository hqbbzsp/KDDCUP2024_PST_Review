        ...
        for sentences in passage_sentences:
            ...
            for j,sentence in enumerate(sentences):
                ...
                if item_str in sentence:
                    ...
                    # else :
                    #     sentences_select.append(" ")
                    # start_index = sentence.find(item_str)
                    # end_index = start_index + len(item_str)
                    # sentences_select.append(sentence[:start_index])
                    # sentences_select.append(sentence[end_index:])
